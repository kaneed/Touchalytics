...
for other_user_count in range(1,41):
    ...
    for user in range(1, num_users+1):
        ...
        dtf_TrainTestGroups = datasplitter.splitByNUsers(dtf, user, other_user_count)
...
plt.savefig("graphs/figure7_eer-vs-user-count.png", bbox_inches="tight")
plt.show()
